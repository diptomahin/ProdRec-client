...
const QueryDetails = () => {
  ...
  useEffect(() => {
    fetch(
      `https://prod-rec-server-site.vercel.app/recommendations/${queryDetails._id}`
    )
      .then((res) => res.json())
  ...
  const handleAddRecommendation = (e) => {
    ...
    axios
      .post(
        "https://prod-rec-server-site.vercel.app/recommendations",
        recommendationData
      )
      .then((res) => {
        ...
        if (res.data.acknowledged === true) {
          ...
          axios
            .put(
              `https://prod-rec-server-site.vercel.app/update-recommendation-count/${queryDetails._id}`,
              recommendationCount
            )
            .then((res) => {
              console.log(res.data);
