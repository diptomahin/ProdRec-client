  ...
  const handleRecommendationDelete = (id, q_id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .delete(
            `https://prod-rec-server-site.vercel.app/recommendations/${id}`
          )
          .then((res) => {
            ...
            if (res.data.deletedCount > 0) {
              ...
              axios
                .put(
                  `https://prod-rec-server-site.vercel.app/decrease-recommendationCount/${q_id}`
                )
                .then((res) => {
                  console.log(res.data);
                });
